...
const ContestProblemDetail: React.FC = () => {
 ...
 // ContestProblemDetail.tsx mein fetchContest function
const fetchContest = async () => {
  try {
    console.log("🎯 Loading contest problem:", { contestId, problemId })
    
    // ADD THIS VALIDATION
    if (problemId && problemId.startsWith('placeholder-')) {
      console.error("❌ Invalid problemId - placeholder:", problemId)
      showError("Please select a valid problem from the contest list.")
      setLoading(false)
      return
    }
    ...
    showError("Failed to load problem. Please go back and select a valid problem.")
  } finally {
    setLoading(false)
  }
}
