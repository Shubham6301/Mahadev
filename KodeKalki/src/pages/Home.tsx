    ...
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900 px-4">
      <div className="text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-2">
          Loading <span className="text-orange-600">KodeKalki</span>...
        </h2>
    ...
    >
      ...
      {!isDark && (
        <>
          ...
          <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
            ...
            ></div>
            <div
              className="absolute top-3/4 right-1/4 w-32 h-32 bg-gradient-to-br from-indigo-200/20 to-violet-200/20 light-morph rounded-full blur-lg"
            ...
            <div className="absolute top-1/6 right-1/4 w-3 h-3">
              <div
                className="light-orbit absolute w-1.5 h-1.5 bg-gradient-to-r from-green-400/40 to-cyan-400/40 rounded-full shadow-lg"
            ...
            ></div>
            <div
              className="absolute top-1/2 left-0 w-60 h-60 color-shift rounded-full blur-2xl opacity-20"
              style={{ animationDelay: "2s" }}
            ></div>
            <div
              className="absolute bottom-1/4 right-0 w-72 h-72 color-shift rounded-full blur-3xl opacity-15"
              style={{ animationDelay: "6s" }}
            ></div>
          </div>
        </>
      ...
      <div className="relative overflow-hidden min-h-screen">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute -bottom-40 -left-40 w-80 h-80 bg-white/10 rounded-full blur-3xl animate-pulse morphing-blob"
            style={{ animationDelay: "4s" }}
          ></div>
          ...
          <div
            className="absolute bottom-1/4 right-1/3 w-24 h-24 bg-gradient-to-br from-pink-400/10 to-orange-400/10 rounded-full blur-2xl floating-ball"
            style={{ animationDelay: "2s" }}
          ></div>
        </div>
        ...
        <div className="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 pb-0 pt-0 sm:pt-6 md:pt-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center h-screen">
            ...
            <div className="z-10 space-y-8 card-animate-in">
              <div className="space-y-3">
                <h1
                  ...
                  } leading-[1.2] relative elegant-float ${
                    getResponsiveSettings().gapClass
                  }`}
                >
                ...
                <p
                  ...
                  } leading-relaxed max-w-2xl card-animate-in`}
                  style={{ animationDelay: "0.2s" }}
                >
                  Join thousands of developers mastering coding skills through
                  our comprehensive platform featuring
                  <span
              ...
              {!user ? (
                <div
                  className={`flex flex-col sm:flex-row gap-4 card-animate-in ${
                    getResponsiveSettings().buttonGap
                  }`}
                ...
                >
                  <Link
                    ...
                    } px-8 py-4 rounded-2xl font-bold transition-all duration-300 inline-flex items-center justify-center shadow-2xl ${
                      isDark
                        ? "hover:shadow-white/25"
                        : "hover:shadow-blue-500/25"
                    } hover:scale-105 magnetic-hover`}
                  >
                    <div
                      className={`absolute inset-0 ${
                        isDark
                          ? "bg-gradient-to-r from-blue-600 to-purple-600 opacity-0 group-hover:opacity-10"
                          : "bg-gradient-to-r from-white/20 to-white/10 opacity-0 group-hover:opacity-100"
                      } transition-opacity duration-300 gradient-animate`}
                    ></div>
                  ...
                  <Link
                    ...
                    className={`group ${
                      isDark
                        ...
                        : "border-2 border-gray-900/50 text-gray-900 hover:bg-gray-900 hover:text-white"
                    } px-8 py-4 rounded-2xl font-bold transition-all duration-300 inline-flex items-center justify-center backdrop-blur-sm hover:scale-105 magnetic-hover`}
                  >
            ...
            <div
              className="relative card-animate-in hidden md:block"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            >
              Discover curated problem sets and learning paths designed to take
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <div className="flex items-center justify-center space-x-2">
                <div
                  className={`w-12 h-[2px] bg-gradient-to-r from-transparent ${
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div
                className={`group relative overflow-hidden rounded-3xl transition-all duration-700 hover:scale-[1.03] transform-gpu ${
                  isDark
              ...
              >
                ...
                <div className="relative p-8 z-10">
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="relative">
                        ...
                        <div className="absolute -top-2 -right-2 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center animate-pulse">
                          <span className="text-xs text-white font-bold animate-bounce delay-200">
                            !
                          </span>
                        </div>
                        {/* Ripple Effect */}
                  ...
                  >
                    Redeem your hard-earned coins for amazing rewards! Get
                    exclusive merchandise, gift cards, and premium features.
                  </p>
                    ...
                    {[
                      ...
                      <div
                        ...
                        className={`text-center p-3 rounded-lg transition-all duration-500 hover:scale-110 hover:rotate-2 transform-gpu ${
                          isDark
                            ? "bg-gray-700/50 hover:bg-gray-700 border border-white/20 hover:border-white/40"
                            : "bg-white/70 hover:bg-white border border-black/20 hover:border-black/40"
                        } hover:shadow-xl`}
              ...
              >
                ...
                <div className="relative p-8 z-10">
                  ...
                  >
                    Solve 100% of problems from top tech companies and earn
                    professional certificates to boost your portfolio!
                  </p>
                    ...
                    {topCompanies.slice(0, 4).map((company, index) => (
                      <Link
                        ...
                        className={`group/company p-3 rounded-lg transition-all duration-500 hover:scale-105 transform-gpu ${
                          isDark
                            ? "bg-gray-700/50 hover:bg-gray-700 border border-white/20 hover:border-white/40"
                            : "bg-white/70 hover:bg-white border-2 border-black/20 hover:border-black/40"
                        } hover:shadow-xl hover:border-blue-300`}
                        style={{ animationDelay: `${index * 100}ms` }}
                      >
                        <div className="flex items-center space-x-3">
                          <div
                            className={`w-10 h-10 bg-gradient-to-br ${company.color} rounded-lg flex items-center justify-center text-white font-bold text-lg group-hover/company:rotate-12 group-hover/company:scale-110 transition-all duration-500 shadow-lg`}
                          >
                          ...
                          <div className="transform transition-all duration-300 group-hover/company:translate-x-1">
                            <div
                              className={`font-semibold ${
                                ...
                                isDark
                                  ? "group-hover/company:text-blue-400"
                                  : "group-hover/company:text-blue-600"
                              } transition-colors duration-300`}
                            >
                              {company.name}
                            </div>
                            <div
                              className={`text-xs ${
                                ...
                                isDark
                                  ? "group-hover/company:text-blue-300"
                                  : "group-hover/company:text-blue-500"
                              } transition-colors duration-300`}
                            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          ...
          <div
            className={`relative overflow-hidden rounded-3xl p-8 transition-all duration-300 ${
              isDark
                ? "bg-gray-800/50 border-2 border-white/30 hover:border-white/50"
                : "bg-white border-2 border-black/30 hover:border-black/50"
        ...
        <div
          className={`relative overflow-hidden rounded-3xl p-6 sm:p-8 lg:p-12 mb-20 ${
            isDark
              ? "bg-gray-800/50 border-2 border-white/30"
        ...
        >
          ...
          <div className="relative">
            <div className="text-center mb-8 sm:mb-12">
              ...
              >
                Master essential skills with our curated learning paths and
                ...
                {[
                  {
                    ...
                    description:
                      "Master the fundamentals of DSA with comprehensive tutorials and practice problems",
                    link: "https://www.youtube.com/watch?v=y3OOaXrFy-Q&list=PLQEaRBV9gAFu4ovJ41PywklqI7IyXwr01",
                    image:
                      "https://tse3.mm.bing.net/th/id/OIP.IodRARzhZ9CBPYBS2_9LEgHaEK?pid=Api&P=0&h=180",
                  ...
                  },
                  {
                    title: "System Design",
                    description:
                      "Learn how to design scalable systems and architect robust applications",
                    link: "https://www.youtube.com/watch?v=AK0hu0Zxua4&list=PLQEaRBV9gAFvzp6XhcNFpk1WdOcyVo9qT",
                    image:
                      "https://tse2.mm.bing.net/th/id/OIP.0iCWYNiceXNXodc6dWCZewHaDe?pid=Api&P=0&h=180",
                  ...
                  },
                  {
                    ...
                    image:
                      "https://i.ytimg.com/vi/tVzUXW6siu0/hqdefault.jpg?sqp=-oaymwEXCOADEI4CSFryq4qpAwkIARUAAIhCGAE=&rs=AOn4CLBenW1M30gqWfrb8bLNydwUJiebEA",
                  ...
                  },
                  {
                    title: "Spring Boot",
                    description:
                      "Master Java Spring Boot framework for enterprise application development",
                    link: "https://www.youtube.com/watch?v=Zxwq3aW9ctU&list=PLsyeobzWxl7qbKoSgR5ub6jolI8-ocxCF",
                    image:
                      "https://i.ytimg.com/vi/Zxwq3aW9ctU/hqdefault.jpg?sqp=-oaymwEXCOADEI4CSFryq4qpAwkIARUAAIhCGAE=&rs=AOn4CLBPvSBVpeCabK8qzRMBY6XNM4VRSw",
                  ...
                  },
                  {
                    title: "Generative AI",
                    description:
                      "Explore the cutting-edge world of AI and machine learning technologies",
                    link: "https://www.youtube.com/watch?v=WOyZid8OkkI&list=PLd7PleJR_EFfRYiLdagOsv4FczMl1Cxt_",
                    image:
                      "https://i.ytimg.com/vi/WOyZid8OkkI/hq720.jpg?sqp=-oaymwEXCNAFEJQDSFryq4qpAwkIARUAAIhCGAE=&rs=AOn4CLAr8shMX8h7efRCCis0s5kBP0Iugw",
                  ...
                  >
                    ...
                    <div className="relative flex items-center p-4 w-full">
                      <div className="flex-shrink-0 mr-4">
                        ...
                        />
                        <div className="text-2xl mt-1 text-center">
                          {topic.icon}
                        </div>
                      </div>
                      <div className="flex-1 min-w-0">
              ...
              <div className="flex gap-6 pb-4" style={{ width: "max-content" }}>
                {[
                  ...
                  >
                    ...
                    <div className="relative h-full flex flex-col">
                      ...
                      <div className="relative h-48 overflow-hidden rounded-t-3xl">
                        ...
                        <div className="absolute top-4 right-4">
                          <div
                            className={`w-12 h-12 bg-gradient-to-br ${topic.color} rounded-2xl flex items-center justify-center text-white text-xl group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 shadow-lg`}
                          >
                            {topic.icon}
                          </div>
                        </div>
                      ...
                      >
                        ...
                        <div className="mt-4">
                          <div
                            className={`inline-flex items-center px-4 py-2 rounded-xl bg-gradient-to-r ${
                              topic.color
                            } text-white font-medium text-sm shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105 ${
                    ...
                    {/* Hover Glow Effect */}
                    <div
                      className={`absolute inset-0 rounded-3xl bg-gradient-to-r ${topic.color} opacity-0 group-hover:opacity-10 blur-xl transition-opacity duration-500`}
                    ></div>
                  </a>
                ))}
              </div>
        ...
        >
          ...
          <div className="relative">
            <div className="text-center mb-8 sm:mb-12">
              ...
              >
                Prepare for interviews at top tech companies with curated
                problem sets and real interview questions
              </p>
            </div>
            ...
            <div className="overflow-x-auto scrollbar-hide">
              <div
                className="flex gap-4 sm:gap-8 pb-4"
                    ...
                    <div className="relative h-full flex flex-col">
                      ...
                      <div className="h-32 sm:h-48 overflow-hidden rounded-t-3xl relative">
                        ...
                        <div className="absolute top-4 right-4">
                          <div className="flex items-center px-3 py-1 rounded-full text-xs font-medium bg-black/50 text-white backdrop-blur-sm">
                            ...
                            {Number(company.stats.avgAcceptanceRate).toFixed(2)}
                            % avg
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex-1 p-6 flex flex-col justify-between">
                        <div>
                          ...
                          >
                            Master {company.name} interview questions with our
                            curated problem collection and real interview
                            experiences.
                          </p>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            >
                              {statsLoading
                                ? "..."
                                : company.stats.count.toLocaleString()}
                            </span>
                          </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex items-center justify-between text-xs">
                              ...
                              <span
                                className={`font-medium ${company.textColor} ${
                                  isDark ? company.darkTextColor : ""
                                }`}
                              >
                                {company.stats.avgAcceptanceRate}%
          ...
          <div className="relative">
            <div className="text-center mb-16">
              ...
              >
                ...
                you need to become an exceptional programmer
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "2000+ coding problems from easy to expert level with detailed solutions",
                  link: "/problems",
                ...
                },
                {
                  ...
                  description:
                    "Weekly contests to compete with programmers worldwide and climb rankings",
                  link: "/contest",
                ...
                },
                {
                  ...
                  description:
                    "Challenge others in live coding battles with anti-cheat protection",
                  link: "/game",
                ...
                },
                {
                  ...
                  title: "Community",
                  description:
                    "Connect with developers, share solutions, and learn together",
                  link: "/top",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-300 mb-8 max-w-md text-lg leading-relaxed">
                Master coding skills with our comprehensive platform featuring
                problems, contests, and real-time battles. Join thousands of
                developers improving their skills every day.
              </p>
                ...
                {[
                  {
                    ...
                    text: "shubhamsaxena6301gmail.com",
                  },
                  {
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2026 KodeKalki. All rights reserved. Built with ❤️ for
              developers.
            </p>
