...
const Badge: React.FC<{
  ...
  const variantClasses = {
    ...
    outline: "border-2 border-gray-300 bg-white text-gray-700 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200",
...
const Contest: React.FC = () => {
  ...
  const handleViewContestDetails = (contestId: string) => {
  ...
  if (loading) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-slate-900 flex items-center justify-center">
        <div className="text-center">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <CardContent className="space-y-3 sm:space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-4">
                    <div className="flex items-center text-gray-600 dark:text-gray-300">
                      ...
                      <div>
                        <p className="text-[10px] sm:text-xs font-medium text-gray-500 dark:text-gray-400">Start Time</p>
                    ...
                    <div className="flex items-center text-gray-600 dark:text-gray-300">
                      ...
                      <div>
                        <p className="text-[10px] sm:text-xs font-medium text-gray-500 dark:text-gray-400">Duration</p>
                    ...
                    <div className="flex items-center text-gray-600 dark:text-gray-300">
                      ...
                      <div>
                        <p className="text-[10px] sm:text-xs font-medium text-gray-500 dark:text-gray-400">Participants</p>
                    ...
                    <div className="flex items-center text-gray-600 dark:text-gray-300">
                      ...
                      <div>
                        <p className="text-[10px] sm:text-xs font-medium text-gray-500 dark:text-gray-400">Problems</p>
                  ...
                  {actualStatus === "upcoming" && (
                    <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900 dark:border-blue-700 p-2 sm:p-4 rounded-lg">
                      <p className="text-xs sm:text-sm text-blue-700 dark:text-blue-300 font-medium mb-1">Contest starts in</p>
                  ...
                  {actualStatus === "ongoing" && (
                    <div className="bg-green-50 border border-green-200 dark:bg-green-900 dark:border-green-700 p-2 sm:p-4 rounded-lg">
                      <p className="text-xs sm:text-sm text-green-700 dark:text-green-300 font-medium mb-1 flex items-center">
                  ...
                  {actualStatus === "ended" && contest.participants.length > 0 && (
                    <div className="bg-gray-50 border border-gray-200 dark:bg-gray-700 dark:border-gray-600 p-2 sm:p-4 rounded-lg">
                        ...
                        {contest.participants
                          ...
                          .map((participant, index) => (
                            <div key={index} className="flex items-center justify-between">
                              ...
                              <span className="text-xs sm:text-sm font-bold text-blue-600 dark:text-blue-400">{participant.score} pts</span>
                            </div>
                          ))}
                      </div>
                    </div>
        ...
        {filteredContests.length === 0 && (
          <div className="text-center py-10 sm:py-16">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 sm:p-12 max-w-xs sm:max-w-md mx-auto">
