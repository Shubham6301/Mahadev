                  ...
                  {Array.from(
                    new Map(
                      profile.solvedProblems
                        ...
                        .map(problem => [problem._id, problem])
                    ).values()
                  )
                    .slice(0, 10)
                    .map((problem, index) => (
                      <div key={problem._id || index} className="flex items-center justify-between py-2 px-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <div className="flex items-center">
