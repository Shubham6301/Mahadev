...
export const API_CONFIG = {
  ...
  BASE_URL: import.meta.env.VITE_API_URL || 
    (import.meta.env.MODE === 'development' ? 'http://localhost:5000/api' : 'https://kodekalkiprefinal-6.onrender.com/api'),
  SOCKET_URL: import.meta.env.VITE_SOCKET_URL || 
    (import.meta.env.MODE === 'development' ? 'http://localhost:5000' : 'https://kodekalkiprefinal-6.onrender.com'),
};
