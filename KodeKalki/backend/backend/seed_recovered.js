...
const seedData = async () => {
  try {
    ...
    const adminUser = new User({
      ...
      email: 'shubhamsaxena6301@gmail.com',
      password: 'Saxena@12',
      role: 'admin'
    });
...
-10^6 <= nums1[i], nums2[i] <= 10^6`,
    ...
    const announcement = new Announcement({
      title: "Welcome to KodeKalki!",
      content:
        "Start solving problems and improve your coding skills. Join contests and compete with other programmers!",
      type: "general",
      priority: "high",
      createdBy: adminUser._id,
    });
